...
/**
 * By default, creates a fresh express server (prod setup). Can pass in configured
 * app (i.e. a webpack dev server) for development and test purposes.
 * CAUTION: If passed in, mutates the passed in express app.
 */
