...
export default [
  ...
  },
  {
    ...
    defaultMessage: 'GYMI won the Columbia University Earth Summit Social Venture Challenge hosted by the Resolution Project.',
  },
  {
    id: 'TimelinePage.april2013.description',
    defaultMessage: 'GYMI Members donate over 1000 RMB to buy lanterns for those affected by the Sichuan earthquake in hopes of raising awareness for the earthquake.',
  },
  {
    id: 'TimelinePage.summer2013.description',
    defaultMessage: 'GYMI piloted two summer sessions and was featured in its first article!',
  },
  {
    id: 'TimelinePage.winter2013.description',
    defaultMessage: 'GYMI pilots its first online mentorship program.',
  },
  {
